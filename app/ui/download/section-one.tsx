    ...
    <>
      ...
      <div className="m-16 sm:flex justify-between">
        <div>
          ...
          <p>The open source operating system powers millions of PCs and laptops around the world.</p>
          ...
          <div className="p-6">
            <p className="text-xl">The secure, modern operating system used by millions</p>
            <div className="ml-8">
