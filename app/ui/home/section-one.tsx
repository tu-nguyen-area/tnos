  ...
  <section>
    <div className="md:flex justify-between md:py-8">
      <div className="text-black md:pb-12">
        <p className="text-2xl md:text-3xl"><span className="text-2xl md:text-3xl bg-gradient-to-r from-blue-500 via-purple-500 to-rose-500 bg-clip-text font-bold text-transparent text-center">TNOS 0.0.6</span> is now available for download</p>
